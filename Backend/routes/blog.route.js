...
import { createBlog, deleteBlog, getOwnBlogs, getPublishedBlog, getTotalBlogLikes, likeBlog, togglePublishBlog, updateBlog } from '../controllers/blog.controller.js';
...
router.route("/:id/like").get(isAuthenticated,likeBlog)
router.route("/my-blogs/likes").get(isAuthenticated,getTotalBlogLikes)
